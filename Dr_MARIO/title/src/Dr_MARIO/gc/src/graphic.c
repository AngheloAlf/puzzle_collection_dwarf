...
} * gp /* r27 */, long glist_size /* r28 */, unsigned long flag /* r29 */) {
    // References
    // -> long * env[70];
...
union {
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} F3SetupRSP_dl[]; // size: 0x0, address: 0x24B10
union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} F3RDPinit_dl[]; // size: 0x0, address: 0x24A10
union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} F3SetupRDP_dl[]; // size: 0x0, address: 0x24AF0
...
union {
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} S2RDPinit_dl[]; // size: 0x0, address: 0x24938
...
union {
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} S2ClearCFB_dl[]; // size: 0x0, address: 0x249A0
