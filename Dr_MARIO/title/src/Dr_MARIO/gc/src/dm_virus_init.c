...
int dm_get_first_virus_count(@enum$107dm_title_main_c mode /* r1+0x8 */, struct {
    // total size: 0x3C4
...
void _dm_virus_init(@enum$107dm_title_main_c mode /* r14 */, struct {
    // total size: 0x3C4
    unsigned long game_score; // offset 0x0, size 0x4
    unsigned short game_retry; // offset 0x4, size 0x2
    signed short map_x; // offset 0x6, size 0x2
...
void dm_virus_init(@enum$107dm_title_main_c mode /* r3 */, struct {
    // total size: 0x3C4
    unsigned long game_score; // offset 0x0, size 0x4
    unsigned short game_retry; // offset 0x4, size 0x2
    signed short map_x; // offset 0x6, size 0x2
