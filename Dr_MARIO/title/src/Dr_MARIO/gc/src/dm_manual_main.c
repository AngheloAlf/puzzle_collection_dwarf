...
*/
static struct_tex_func_c_8 * _texAll; // size: 0x4, address: 0x583A0
static struct_tex_func_c_8 * _texKaSa; // size: 0x4, address: 0x583A4
struct STutolWnd {
    // total size: 0x90
    int pos[2]; // offset 0x0, size 0x8
    float alpha; // offset 0x8, size 0x4
    float alphaStep; // offset 0xC, size 0x4
    struct_main_story_c_2 msgWnd[1]; // offset 0x10, size 0x80
};
union_drmario_gc_c_0 normal_texture_init_dl[]; // size: 0x0, address: 0x4208
// Range: 0x57228 -> 0x573F4
static void tutolWnd_draw(struct STutolWnd * wnd /* r29 */, union_drmario_gc_c_0 * * gpp /* r30 */) {
    // Local variables
    union_drmario_gc_c_0 * gp; // r1+0x10
    struct_tex_func_c_8 * texC; // r4
    int alpha; // r31
...
struct_dm_manual_main_c_103 * watchManual; // size: 0x4, address: 0x583A8
...
static void dm_manual_update_virus_anime(struct_dm_game_main_c_17 * state /* r30 */) {
    // Local variables
    int i; // r31
}
...
@enum$100dm_game_main_c dm_manual_main_cnt(struct_dm_game_main_c_17 * state /* r29 */, struct {
    // total size: 0xA
    ...
    // Local variables
    struct_dm_manual_main_c_103 * st; // r31
    int i; // r28
    int out; // r28
...
static void dm_manual_make_key(struct_dm_game_main_c_17 * state /* r27 */, struct {
    // total size: 0xA
    signed char pos_m_x; // offset 0x0, size 0x1
    signed char pos_m_y; // offset 0x1, size 0x1
    signed char capsel_m_g; // offset 0x2, size 0x1
    ...
    // Local variables
    struct_dm_manual_main_c_103 * st; // r30
    struct_dm_game_main_c_19 * cap; // r29
...
static @enum$110dm_title_main_c dm_manual_1_main() {
    // Local variables
    struct_dm_manual_main_c_103 * st; // r1+0x8
    struct_dm_game_main_c_17 * state; // r29
    struct_dm_game_main_c_18 * map; // r28
...
static @enum$110dm_title_main_c dm_manual_4_main() {
    // Local variables
    struct_dm_manual_main_c_103 * st; // r1+0x8
    struct_dm_game_main_c_17 * state; // r30
    struct_dm_game_main_c_18 * map; // r29
    int i; // r1+0x8
    int j; // r1+0x8
...
static void dm_manual_draw_fg(union_main_story_c_4 * * mpp /* r30 */, union {
...
void dm_manual_all_init() {
    // Local variables
    struct_dm_manual_main_c_103 * st; // r23
    int i; // r1+0x8
    int j; // r22
    int k; // r21
    void * heap; // r20
    ...
    struct_dm_manual_main_c_104 * acap; // r8
...
int dm_manual_main() {
    // Local variables
    struct_dm_manual_main_c_103 * st; // r21
    int i; // r22
    int key; // r4
...
void dm_manual_graphic() {
    // Local variables
    struct_dm_manual_main_c_103 * st; // r31
    union_main_story_c_4 * mp; // r1+0x14
    union_tex_func_c_7 * vp; // r1+0x10
