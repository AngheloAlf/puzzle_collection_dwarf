...
static struct_main_story_c_1 * * etcLwsAddress; // size: 0x4, address: 0x1CEB4
static struct_main_story_c_1 * etcLwsTbl[16]; // size: 0x40, address: 0x1CEB8
static unsigned long logo_ofsY; // size: 0x4, address: 0x1CEF8
static int etc_mode; // size: 0x4, address: 0x1CEFC
static struct_game_etc_c_52 g_etc_work[4]; // size: 0x3C0, address: 0x1CF00
static union_main_story_c_4 etc_viewMtx; // size: 0x40, address: 0x1D2C0
static struct_main_story_c_5 etc_vp; // size: 0x10, address: 0x5198
static union_drmario_gc_c_0 etc_setup[19]; // size: 0x98, address: 0x51A8
...
struct_game_etc_c_53 attack_effect[16]; // size: 0x2C0, address: 0x1D308
int attack_sprite_idx; // size: 0x4, address: 0x1D5C8
struct_game_etc_c_54 attack_sprite[128]; // size: 0xA00, address: 0x1D5CC
...
void disp_logo_setup(union_drmario_gc_c_0 * * glp /* r30 */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r31
...
int disp_count_logo(union_drmario_gc_c_0 * * glp /* r31 */, int player /* r1+0xC */, int count /* r29 */) {
    // Local variables
...
void disp_clear_logo(union_drmario_gc_c_0 * * glp /* r29 */, int player /* r1+0xC */, int flg /* r28 */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x54
    struct_game_etc_c_52 * pge; // r30
    long pm[4][4]; // r1+0x14
    long x; // r1+0x8
    long y; // r5
    union_drmario_gc_c_0 * _g; // r1+0x8
...
void disp_allclear_logo(union_drmario_gc_c_0 * * glp /* r29 */, int player /* r1+0xC */, int flg /* r28 */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x54
    struct_game_etc_c_52 * pge; // r30
    long pm[4][4]; // r1+0x14
...
void disp_win_logo(union_drmario_gc_c_0 * * glp /* r30 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x50
    struct_game_etc_c_52 * pge; // r31
    long pm[4][4]; // r1+0x10
    long x; // r4
    long y; // r5
    union_drmario_gc_c_0 * _g; // r1+0x8
...
void disp_lose_logo(union_drmario_gc_c_0 * * glp /* r30 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x50
    struct_game_etc_c_52 * pge; // r31
    long pm[4][4]; // r1+0x10
...
void disp_draw_logo(union_drmario_gc_c_0 * * glp /* r30 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x50
    struct_game_etc_c_52 * pge; // r31
    long pm[4][4]; // r1+0x10
...
int disp_pause_logo(union_drmario_gc_c_0 * * glp /* r25 */, int player /* r1+0xC */, int cursor /* r26 */, int type /* r1+0x18 */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x84
    struct_game_etc_c_52 * pge; // r27
    struct_main_story_c_6 gbi; // r1+0x70
    struct_main_story_c_6 gbia; // r1+0x5C
    long pm[4][4]; // r1+0x1C
    float fx; // f31
    float fy; // f30
    int a; // r1+0x8
...
int etc_continue_logo(union_drmario_gc_c_0 * * glp /* r25 */, int player /* r1+0xC */, int cursor /* r26 */, int type /* r27 */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x44
    struct_game_etc_c_52 * pge; // r28
    struct_main_story_c_6 gbi; // r1+0x30
    struct_main_story_c_6 gbia; // r1+0x1C
    float fx; // f31
    float fy; // f30
    union_drmario_gc_c_0 * _g; // r1+0x8
    union_drmario_gc_c_0 * _g; // r1+0x8
...
int disp_continue_logo(union_drmario_gc_c_0 * * glp /* r3 */, int player /* r4 */, int cursor /* r5 */, int type /* r6 */) {
    // Local variables
    struct_game_etc_c_52 * pge; // r9
...
int disp_continue_logo_score(union_drmario_gc_c_0 * * glp /* r3 */, int player /* r4 */, int cursor /* r5 */, int type /* r6 */) {
    // Local variables
    struct_game_etc_c_52 * pge; // r1+0x8
...
void disp_gameover_logo(union_drmario_gc_c_0 * * glp /* r31 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x50
    struct_game_etc_c_52 * pge; // r29
    long pm[4][4]; // r1+0x10
    long x; // r1+0x8
    long y; // r5
    union_drmario_gc_c_0 * _g; // r1+0x8
...
void disp_timeover_logo(union_drmario_gc_c_0 * * glp /* r31 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x50
    struct_game_etc_c_52 * pge; // r29
    long pm[4][4]; // r1+0x10
...
void disp_retire_logo(union_drmario_gc_c_0 * * glp /* r31 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x50
    struct_game_etc_c_52 * pge; // r29
    long pm[4][4]; // r1+0x10
...
void disp_timestop_logo(union_drmario_gc_c_0 * * glp /* r23 */, int player /* r1+0xC */) {
    // Local variables
    union_drmario_gc_c_0 * pgfx; // r1+0x24
    struct_game_etc_c_52 * pge; // r1+0x8
    struct_main_story_c_6 gbi; // r1+0x10
    union_drmario_gc_c_0 * _g; // r1+0x8
    union_drmario_gc_c_0 * _g; // r1+0x8
    union_drmario_gc_c_0 * _g; // r1+0x8
    union_drmario_gc_c_0 * _g; // r1+0x8
...
void disp_attack_effect(union_drmario_gc_c_0 * * glp /* r18 */) {
    // Local variables
    int i; // r21
    int tmp; // r17
    int a; // r1+0x8
    unsigned long addr; // r6
    union_drmario_gc_c_0 * pgfx; // r1+0xC
    float x; // f30
    float y; // f29
    float t; // f5
    float scl; // f31
