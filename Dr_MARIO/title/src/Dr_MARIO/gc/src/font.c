...
static union_drmario_gc_c_202 init_dl$135[5]; // size: 0x28, address: 0x1208
// Range: 0x27430 -> 0x27454
void font16_initDL(union_drmario_gc_c_202 * * gpp /* r1+0x0 */) {
    // Local variables
...
void font16_initDL2(union_drmario_gc_c_202 * * gpp /* r1+0x0 */) {
    // Local variables
...
void fontXX_draw(union_drmario_gc_c_202 * * gpp /* r3 */, float x /* f1 */, float y /* f2 */, float w /* f3 */, float h /* f4 */, unsigned char * charcode /* r1+0x1C */) {
    // References
    // -> unsigned short char_code_tbl[6239];
}

// Range: 0x2759C -> 0x278B8
int fontXX_drawID(union_drmario_gc_c_202 * * gpp /* r1+0x8 */, float x /* r1+0xC */, float y /* r1+0x10 */, float w /* r1+0x14 */, float h /* r1+0x18 */, int index /* r1+0x1C */) {
    // Local variables
...
void fontXX_draw2(union_drmario_gc_c_202 * * gpp /* r3 */, float x /* f1 */, float y /* f2 */, float w /* f3 */, float h /* f4 */, unsigned char * charcode /* r1+0x1C */) {
    // References
    // -> unsigned short char_code_tbl[6239];
}

// Range: 0x27934 -> 0x27E4C
int fontXX_drawID2(union_drmario_gc_c_202 * * gpp /* r1+0x8 */, float x /* r1+0xC */, float y /* r1+0x10 */, float w /* r1+0x14 */, float h /* r1+0x18 */, int index /* r1+0x1C */) {
    // Local variables
    unsigned char * tex; // r1+0x8
    int i; // r4
    union_drmario_gc_c_202 * _g; // r1+0x8
...
void fontAsc_draw(union_drmario_gc_c_202 * * gpp /* r3 */, float x /* f1 */, float y /* f2 */, float w /* f3 */, float h /* f4 */, unsigned char * charcode /* r1+0x1C */) {
    // Local variables
    int index; // r4
...
int fontAsc_drawID(union_drmario_gc_c_202 * * gpp /* r1+0x8 */, float x /* r1+0xC */, float y /* r1+0x10 */, float w /* r1+0x14 */, float h /* r1+0x18 */, int index /* r1+0x1C */) {
    // Local variables
    unsigned char * tex; // r1+0x8
    int blk; // r1+0x8
    union_drmario_gc_c_202 * _g; // r1+0x8
...
void fontAsc_draw2(union_drmario_gc_c_202 * * gpp /* r3 */, float x /* f1 */, float y /* f2 */, float w /* f3 */, float h /* f4 */, unsigned char * charcode /* r1+0x1C */) {
    // Local variables
    int index; // r4
...
int fontAsc_drawID2(union_drmario_gc_c_202 * * gpp /* r1+0x8 */, float x /* r1+0xC */, float y /* r1+0x10 */, float w /* r1+0x14 */, float h /* r1+0x18 */, int index /* r1+0x1C */) {
    // Local variables
    unsigned char * tex; // r1+0x8
    int i; // r4
    union_drmario_gc_c_202 * _g; // r1+0x8
