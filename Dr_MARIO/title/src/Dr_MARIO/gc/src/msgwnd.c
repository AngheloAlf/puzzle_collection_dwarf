...
void msgWnd_init2(struct_main_story_c_451 * st /* r3 */, void * heap /* r1+0xC */, int bufSize /* r1+0x10 */, int cols /* r1+0x14 */, int rows /* r1+0x18 */, int x /* r1+0x1C */, int y /* r1+0x20 */) {
    // Local variables
    void * hp; // r1+0x8
}

// Range: 0x28844 -> 0x288A4
void msgWnd_clear(struct_main_story_c_451 * st /* r1+0x0 */) {}

// Range: 0x288A4 -> 0x28ABC
static void msgWnd_layout(struct_main_story_c_451 * st /* r20 */) {
    // Local variables
    int loopFlag; // r26
    int top; // r25
    int col; // r24
...
void msgWnd_addStr(struct_main_story_c_451 * st /* r29 */, const unsigned char * str /* r27 */) {
    // Local variables
    int strLen; // r31
    int bufLen; // r30
}
...
int msgWnd_isEnd(struct_main_story_c_451 * st /* r3 */) {}

// Range: 0x29AE8 -> 0x29B24
void msgWnd_skip(struct_main_story_c_451 * st /* r1+0x8 */) {}

// Range: 0x29B24 -> 0x29B2C
int msgWnd_isSpeaking(struct_main_story_c_451 * st /* r3 */) {}

// Range: 0x29B2C -> 0x29B48
int msgWnd_isScroll(struct_main_story_c_451 * st /* r1+0x0 */) {}

// Range: 0x29B48 -> 0x29B58
int msgWnd_getWidth(struct_main_story_c_451 * st /* r1+0x0 */) {}

// Range: 0x29B58 -> 0x29B68
int msgWnd_getHeight(struct_main_story_c_451 * st /* r1+0x0 */) {}
