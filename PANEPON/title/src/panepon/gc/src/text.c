...
union {
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherLUT[]; // size: 0x0, address: 0xC9770
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture1[]; // size: 0x0, address: 0xD0508
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture2[]; // size: 0x0, address: 0xD0520
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture3[]; // size: 0x0, address: 0xD0538
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture4[]; // size: 0x0, address: 0xD0550
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture5[]; // size: 0x0, address: 0xD0568
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture7[]; // size: 0x0, address: 0xD0598
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture8[]; // size: 0x0, address: 0xD05B0
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture12[]; // size: 0x0, address: 0xD0610
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture13[]; // size: 0x0, address: 0xD0628
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture14[]; // size: 0x0, address: 0xD0640
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture15[]; // size: 0x0, address: 0xD0658
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} otherTexture6[]; // size: 0x0, address: 0xD0580
// Range: 0xA403C -> 0xA429C
void Draw2DTemplate(struct {
    // total size: 0x31B88
    union {
        struct {
            // total size: 0x8
...
union {
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} numberTexture1[]; // size: 0x0, address: 0xD3888
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} numberTexture2[]; // size: 0x0, address: 0xD38A0
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} numberTexture3[]; // size: 0x0, address: 0xD38B8
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} numberTexture4[]; // size: 0x0, address: 0xD38D0
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} numberTexture5[]; // size: 0x0, address: 0xD38E8
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} numberTexture6[]; // size: 0x0, address: 0xD3900
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} shadow2Texture[]; // size: 0x0, address: 0xD4D48
union {
    struct {
        // total size: 0x18
        signed short objX; // offset 0x0, size 0x2
