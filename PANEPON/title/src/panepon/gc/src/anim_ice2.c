/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_ice2.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00032478 -> 0x000325B8
*/
struct block_t {
    // total size: 0x2C
...
// Erased
static void InitIce2(int flag /* r29 */, int anim /* r28 */) {
    // Local variables
    int base; // r6
    int temp; // r6
    char * currSegment; // r3
    ...
    // -> static char * gc_levice2;
}

int gCounter; // size: 0x4, address: 0xF4E80
// Range: 0x32478 -> 0x325B8
void UpdateIce2() {
    // Local variables
    int x; // r28
    int y; // r27
