/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\fade.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0005BED8 -> 0x0005C2E8
*/
static signed short Flash_period[2]; // size: 0x4, address: 0x4D040
static signed short Flash_count[2]; // size: 0x4, address: 0x4D044
signed short gBox_Level; // size: 0x2, address: 0x4D048
signed short gBlock_Level; // size: 0x2, address: 0x4D04A
// Range: 0x5BED8 -> 0x5BF04
void InitGameFade() {
    // References
    // -> static signed short Flash_count[2];
    // -> static signed short Flash_period[2];
    // -> signed short gBlock_Level;
    // -> signed short gBox_Level;
}

// Range: 0x5BF04 -> 0x5BF24
void SetGameFade() {
    // References
    // -> signed short gBlock_Level;
    // -> signed short gBox_Level;
...
// Range: 0x5BF24 -> 0x5C088
void DoGameFade(int factor /* r1+0x0 */) {
    // References
    // -> signed short gBlock_Level;
    // -> static signed short Flash_period[2];
    // -> signed short gBox_Level;
...
// Range: 0x5C1DC -> 0x5C260
int DoFlashDraw(int which /* r1+0x0 */) {
    // References
    // -> static signed short Flash_count[2];
    // -> static signed short Flash_period[2];
}

// Range: 0x5C260 -> 0x5C2E8
int DoFlashDrawAlways() {
    // References
    // -> static signed short Flash_count[2];
    // -> static signed short Flash_period[2];
}
