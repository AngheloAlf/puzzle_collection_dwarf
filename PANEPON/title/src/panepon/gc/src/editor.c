/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\editor.c
...
static void * gpHeapEdit; // size: 0x4, address: 0x4D00C
static int giMenu; // size: 0x4, address: 0x4D010
static int giSlot; // size: 0x4, address: 0x4D014
static int gnMoveCount; // size: 0x4, address: 0x4D018
static int gnTile; // size: 0x4, address: 0x4D01C
...
// Range: 0x51968 -> 0x51B74
static void editTick(int * anCommand /* r29 */) {
    // Local variables
    ...
    // -> static int giCursorX;
    // -> static int giCursorY;
...
static void editTickMakeMove(int * anCommand /* r30 */) {
    // Local variables
    unsigned short anText[3]; // r1+0x10
...
static void editTickMakeSlot(int * anCommand /* r30 */) {
    // Local variables
    int nCode; // r5
    unsigned short anText[3]; // r1+0x10
...
// Range: 0x51EE0 -> 0x521B0
static void editTickMenu(int iFrame /* r29 */, int * anCommand /* r30 */) {
    // References
    // -> struct SfxInitStruct SFX_INIT_TABLE[527];
    // -> static int giSlot;
    // -> static int giMenu;
...
static void editTickEditSlot(int * anCommand /* r30 */) {
    // Local variables
    int nCode; // r5
    int bLoad; // r28
    unsigned short anText[3]; // r1+0x10
...
static void editTickWipe(int * anCommand /* r30 */) {
    // Local variables
    int nCode; // r5
    int bLoad; // r28
    unsigned short anText[3]; // r1+0x10
...
static void editTickWipeSure(int * anCommand /* r29 */) {
    // Local variables
    int nButton; // r1+0x10
    int bFlag; // r30
...
static struct_editor_c_38 gaEditData[8]; // size: 0x40, address: 0xAFF60
...
// Range: 0x52954 -> 0x52A18
static void editDrawImage(union_pon_gc_c_0 * * ppGfx /* r1+0x0 */, int nTag /* r1+0x8 */) {
    // Local variables
...
// Range: 0x52A18 -> 0x52B48
void DrawEditor(struct_pon_gc_draw_c_15 * pDynamic /* r30 */) {
    // References
