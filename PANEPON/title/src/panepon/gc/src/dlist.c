/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\dlist.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00044BB8 -> 0x000463DC
*/
struct block_t {
    // total size: 0x2C
...
// Range: 0x44BB8 -> 0x44D78
void InitCursor(struct cursor_t * cursor /* r1+0x0 */) {
    // Local variables
    int i; // r6
...
// Range: 0x44D78 -> 0x44DA8
void InitGamePad(int num /* r1+0x0 */) {
    // References
    // -> struct Game gTheGame;
}

// Range: 0x44DA8 -> 0x44DD0
void InitTetrisState(struct block_t * block /* r1+0x0 */) {}

union_pon_gc_c_0 * glistp; // size: 0x4, address: 0x50F48
union_pon_gc_c_0 initRDP_dl[]; // size: 0x0, address: 0xB0E00
union_pon_gc_c_0 init3D_dl[]; // size: 0x0, address: 0xB0EB0
union_pon_gc_c_0 init2D_dl[]; // size: 0x0, address: 0xB0E68
// Range: 0x44DD0 -> 0x44EDC
void InitDisplayList(struct_pon_gc_c_3 * info /* r1+0x8 */) {
    // Local variables
...
// Range: 0x459F8 -> 0x45DF4
void pon_InitGameStateVarSpecifiedPlayer(int num /* r23 */) {
    // Local variables
    int index; // r5
    struct tetWell * well; // r27
    struct cursor_t * cursor; // r26
    struct state_t * state; // r25
    struct extra_t * extra; // r24
