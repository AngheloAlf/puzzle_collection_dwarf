/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\attack2d.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00037384 -> 0x000391D0
*/
char st_AttackPosition[4]; // size: 0x4, address: 0xF4718
// Range: 0x37384 -> 0x37570
void Init2DAttackPosition(struct attack_t * attack /* r1+0x0 */, int type /* r1+0x4 */, int num /* r1+0x8 */) {
    // Local variables
    char pattern; // r1+0x0
...
// Range: 0x37570 -> 0x375A8
void Init2DAttackFace(struct attack_t * attack /* r1+0x0 */) {}
...
// Range: 0x375A8 -> 0x37BFC
void Update2DAttackFace(struct tetWell * well /* r1+0x8 */, struct attack_t * attack /* r1+0xC */) {
    // Local variables
    int x; // r5
    int y; // r1+0x8
...
// Range: 0x37BFC -> 0x3825C
void Update2DAttack(struct tetWell * well /* r18 */, struct cursor_t * cursor /* r19 */, int num /* r20 */) {
    // Local variables
    int count; // r7
    int pos; // r25
    int type; // r4
...
// Range: 0x3825C -> 0x385A4
void pon_Update2DAttack4p(struct tetWell * well /* r22 */, struct cursor_t * cursor /* r23 */, int num /* r24 */) {
    // Local variables
    int count; // r7
    int drop; // r26
    int upgrade; // r25
...
// Range: 0x385A4 -> 0x387E4
void Check2DSameAttack(struct tetWell * well /* r27 */, struct cursor_t * cursor /* r28 */, int row /* r29 */, int col /* r6 */, int flag /* r30 */) {
    // Local variables
    int count; // r1+0x8
    int temp; // r3
    int check; // r25
...
// Range: 0x387E4 -> 0x389E8
void Sync2DAttack(struct tetWell * well /* r26 */, struct cursor_t * cursor /* r28 */) {
    // Local variables
    int i; // r1+0x8
    int j; // r4
    int total; // r27
...
// Range: 0x389E8 -> 0x391D0
void Change2DAttack(struct tetWell * well /* r29 */, struct cursor_t * cursor /* r27 */, int num /* r19 */, int combo /* r1+0x14 */) {
    // Local variables
    int count; // r1+0x8
    int temp; // r1+0x8
    int lev; // r5
    ...
    int wait; // r24
    int total; // r23
    int unfreeze; // r1+0x38
    int type; // r1+0x8
    struct block_t * block; // r28
    union_pon_gc_c_1 * rect; // r1+0x8
