/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_green1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0002E9B0 -> 0x0002F8C0
*/
...
// Range: 0x2EC4C -> 0x2F710
void UpdateGreen1(int combo /* r22 */, int chain /* r23 */) {
    // Local variables
    int anim; // r26
    int x; // r25
    int y; // r24
    struct action_t * mascot; // r1+0x8
    int sq_position[15][2]; // r1+0x14
...
// Range: 0x2F710 -> 0x2F8C0
void DrawGreen1Light2D() {
    // Local variables
    int count; // r30
