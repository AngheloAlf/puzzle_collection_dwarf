/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_lion2.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x000325B8 -> 0x00032738
*/
struct block_t {
    // total size: 0x2C
...
// Erased
static void InitLion2(int flag /* r31 */, int anim /* r30 */) {
    // Local variables
    int base; // r6
    int temp; // r7
    char * currSegment; // r3
    ...
    // -> static char * gc_levlion2;
}

// Range: 0x325B8 -> 0x32644
void UpdateLion2() {
    // Local variables
    int index; // r7
    int * ptr; // r4
