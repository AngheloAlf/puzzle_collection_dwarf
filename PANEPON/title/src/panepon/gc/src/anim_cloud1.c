...
void DrawCloud1House2D(struct_pon_gc_draw_c_15 * dynamicp /* r25 */) {
    // Local variables
    union_pon_gc_tex_c_12 bg; // r1+0x38
    union_pon_gc_tex_c_12 bg2; // r1+0x10
...
void DrawCloud1Bubble2D(struct_pon_gc_draw_c_15 * dynamicp /* r1+0x8 */) {
    // Local variables
    union_pon_gc_tex_c_12 * bg; // r4
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
