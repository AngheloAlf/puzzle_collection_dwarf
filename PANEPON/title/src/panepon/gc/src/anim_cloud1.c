/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_cloud1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00029ADC -> 0x0002ADC8
*/
...
// Range: 0x29ED0 -> 0x2A900
void UpdateCloud1(int combo /* r27 */, int chain /* r31 */) {
    // Local variables
    int anim; // r28
    int x; // r3
    int y; // r3
...
// Range: 0x2A900 -> 0x2AC1C
void DrawCloud1House2D(struct_pon_gc_draw_c_2466 * dynamicp /* r25 */) {
    // Local variables
    union_pon_gc_tex_c_17914 bg; // r1+0x38
    union_pon_gc_tex_c_17914 bg2; // r1+0x10
...
// Range: 0x2AC1C -> 0x2ADC8
void DrawCloud1Bubble2D(struct_pon_gc_draw_c_2466 * dynamicp /* r1+0x8 */) {
    // Local variables
    union_pon_gc_tex_c_17914 * bg; // r4
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
