/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\explode.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0005AE6C -> 0x0005B1F8
*/
...
// Range: 0x5AE6C -> 0x5B16C
void PlayExplosionSound(int num /* r1+0x8 */, int sound /* r1+0xC */) {
    // Local variables
    int which; // r4
    int type; // r1+0x8
...
// Range: 0x5B16C -> 0x5B1B8
void StartExplosion(struct tetWell * well /* r3 */, int num /* r4 */, int row /* r5 */, int col /* r6 */, int type /* r7 */) {
    // References
    // -> struct Game gTheGame;
}

// Range: 0x5B1B8 -> 0x5B1F8
void UpdateExplosion(struct tetWell * well /* r3 */) {
    // References
    // -> struct Game gTheGame;
}
