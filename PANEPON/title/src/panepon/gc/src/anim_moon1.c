/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_moon1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0002F8C0 -> 0x00031000
*/
...
// Range: 0x2FC40 -> 0x30B08
void UpdateMoon1(int combo /* r24 */, int chain /* r25 */) {
    // Local variables
    int anim; // r26
    int x; // r1+0x8
    int y; // r6
...
// Range: 0x30B08 -> 0x31000
void DrawMoon1Star2D() {
    // Local variables
    int count; // r9
    int base; // r10
    unsigned short * ptr; // r3
    union_pon_gc_tex_c_17914 bg; // r1+0x250
    unsigned short array1[96]; // r1+0x18C
    unsigned short array2[96]; // r1+0xCC
    unsigned char index1[94]; // r1+0x6C
    unsigned char index2[94]; // r1+0xC
