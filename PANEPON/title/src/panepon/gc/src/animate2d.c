/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\animate2d.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00022738 -> 0x0002387C
*/
struct block_t {
    // total size: 0x2C
...
// Range: 0x22738 -> 0x22B84
void Input2D(struct tetWell * well /* r31 */, struct cursor_t * cursor /* r27 */, int num /* r28 */) {
    // Local variables
    int flag; // r3
    int sound; // r3
    struct gamepad_t * gamepad; // r5
    unsigned short h_button; // r8
    unsigned short t_button; // r30
    unsigned short button; // r29
...
// Range: 0x22B84 -> 0x22C80
int Move2DCursorUp(struct tetWell * well /* r1+0x0 */, struct cursor_t * cursor /* r1+0x4 */, int hold /* r1+0x8 */) {
    // Local variables
    int pixel; // r3
...
// Range: 0x22C80 -> 0x22CFC
int Move2DCursorDown(struct cursor_t * cursor /* r1+0x0 */, int hold /* r1+0x4 */) {
    // Local variables
    int pixel; // r5
...
// Range: 0x22CFC -> 0x22D78
int Move2DCursorLeft(struct cursor_t * cursor /* r1+0x0 */, int hold /* r1+0x4 */) {
    // Local variables
    int pixel; // r5
...
// Range: 0x22D78 -> 0x22DF4
int Move2DCursorRight(struct cursor_t * cursor /* r1+0x0 */, int hold /* r1+0x4 */) {
    // Local variables
    int pixel; // r5
...
// Range: 0x22DF4 -> 0x23368
int Switch2DBlocks(struct tetWell * well /* r27 */, struct cursor_t * cursor /* r28 */, int num /* r29 */) {
    // Local variables
    struct block_t * block1; // r30
    struct block_t * block2; // r31
...
// Range: 0x23368 -> 0x23510
void Update2DSwitching(struct tetWell * well /* r30 */, struct cursor_t * cursor /* r31 */) {
    // Local variables
    struct block_t * block1; // r29
    struct block_t * block2; // r28

    // References
    // -> struct Game gTheGame;
}

// Range: 0x23510 -> 0x2387C
void Add2DNewRow(struct tetWell * well /* r22 */, struct cursor_t * cursor /* r23 */, int num /* r24 */) {
    // Local variables
    int i; // r27
    int j; // r26
    int sound; // r25
