...
static void titleTickRing(struct {
    // total size: 0x1C
    int nX; // offset 0x0, size 0x4
    int nY; // offset 0x4, size 0x4
    int nSize; // offset 0x8, size 0x4
...
static void titleDrawRing(struct {
    // total size: 0x1C
    int nX; // offset 0x0, size 0x4
    int nY; // offset 0x4, size 0x4
    int nSize; // offset 0x8, size 0x4
...
static void titleMakeDust(struct {
    // total size: 0x18
    int nTick; // offset 0x0, size 0x4
    int nWait; // offset 0x4, size 0x4
    int nX; // offset 0x8, size 0x4
    ...
    int nDeltaX; // offset 0x10, size 0x4
    int nDeltaY; // offset 0x14, size 0x4
} * aDust /* r27 */, int nCount /* r26 */, int nX /* r29 */, int nY /* r30 */, int nSizeX /* r31 */, int nSizeY /* r25 */) {
    // Local variables
    int iDust; // r6
    int nSeed; // r10
}
...
static void titleDrawDust(struct {
    // total size: 0x18
    int nTick; // offset 0x0, size 0x4
    int nWait; // offset 0x4, size 0x4
    int nX; // offset 0x8, size 0x4
    ...
    int nDeltaX; // offset 0x10, size 0x4
    int nDeltaY; // offset 0x14, size 0x4
} * aDust /* r1+0x8 */, int nCount /* r1+0xC */, union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
        unsigned int w1; // offset 0x4, size 0x4
...
static void titleDrawImage(union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
        unsigned int w1; // offset 0x4, size 0x4
