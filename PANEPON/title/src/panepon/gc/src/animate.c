/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\animate.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00021450 -> 0x00022738
*/
struct block_t {
    // total size: 0x2C
...
// Range: 0x21450 -> 0x21564
void CheckGameInput(struct tetWell * well /* r30 */, struct cursor_t * cursor /* r31 */, int num /* r6 */) {
    // References
    // -> struct ai_t brainbrain[4];
    // -> struct Game gTheGame;
}

// Range: 0x21564 -> 0x215A4
void AddNewRow(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r4 */, int num /* r5 */) {
    // References
    // -> struct Game gTheGame;
}

// Range: 0x215A4 -> 0x216FC
void RaiseBlocks(struct tetWell * well /* r1+0x0 */, struct cursor_t * cursor /* r1+0x4 */) {
    // Local variables
    int rate; // r6
    int blockHSize; // r7
...
// Range: 0x216FC -> 0x21A7C
void AfterSwitch(struct tetWell * well /* r1+0x8 */, struct cursor_t * cursor /* r1+0xC */, struct block_t * block1 /* r1+0x10 */, struct block_t * block2 /* r1+0x14 */, int dimen /* r1+0x18 */) {
    // Local variables
    int wait; // r8
    int check; // r30
    int row; // r11
...
// Range: 0x21A7C -> 0x21FC0
void CheckShake(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r1+0xC */) {
    // Local variables
    int row; // r28
    int col; // r9
    int top; // r8
...
// Range: 0x21FC0 -> 0x22010
int CheckFieldActive(struct tetWell * well /* r3 */) {
    // Local variables
    int row; // r6
    int col; // r1+0x0
...
// Range: 0x22010 -> 0x22738
int CheckGameOver(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r1+0xC */) {
    // Local variables
    int col; // r6
    int value; // r4
