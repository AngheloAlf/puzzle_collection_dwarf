...
void CreateMenuGfxTask(struct_pon_gc_c_3 * info /* r1+0x8 */) {
    // Local variables
    struct_pon_gc_draw_c_15 * dynamicp; // r30
...
void CreateGameGfxTask1(struct_pon_gc_c_3 * info /* r30 */) {
    // Local variables
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
...
void CreateGameGfxTask2(struct_pon_gc_c_3 * info /* r1+0x8 */) {
    // Local variables
    struct_pon_gc_draw_c_15 * dynamicp; // r3
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
...
void BuildTask(struct_pon_gc_c_3 * info /* r31 */) {
    // Local variables
    struct_pon_gc_draw_c_15 * dynamicp; // r31
