/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\combo.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00041DD4 -> 0x00043348
*/
struct block_t {
    // total size: 0x2C
...
// Range: 0x41DD4 -> 0x41E28
void CheckCollision(struct tetWell * well /* r31 */) {
    // References
...
// Range: 0x41E28 -> 0x42254
void CompactWell(struct tetWell * well /* r31 */, int num /* r19 */) {
    // Local variables
    int row; // r22
    int col; // r21
    int pos; // r4
    struct block_t * bot_block; // r23
    struct block_t * top_block; // r27
    int check[40]; // r1+0x10
    int sound; // r20
...
// Range: 0x42254 -> 0x426F8
void CheckIcon(struct tetWell * well /* r3 */, int total /* r1+0xC */) {
    // Local variables
    int count; // r12
    int special; // r31
    int left; // r7
...
// Range: 0x426F8 -> 0x4282C
void CheckRowCombos(struct tetWell * well /* r26 */) {
    // Local variables
    int i; // r28
    int j; // r27
    int count; // r4
...
// Range: 0x4282C -> 0x42978
void CheckColCombos(struct tetWell * well /* r31 */) {
    // Local variables
    int i; // r25
    int j; // r24
    int count; // r4
    int type; // r3
    struct block_t * block; // r23

    // References
    // -> int gMax;
}

// Range: 0x42978 -> 0x42D3C
void SetRowState(struct tetWell * well /* r3 */, int count /* r4 */, int row /* r1+0x10 */, int col /* r1+0x14 */) {
    // Local variables
    int i; // r27
    int bomb; // r8
    int sound; // r9
    int kind; // r10
    struct icon_t * icon; // r11
    struct block_t * block; // r26
}

// Range: 0x42D3C -> 0x43148
void SetColState(struct tetWell * well /* r3 */, int count /* r4 */, int row /* r1+0x10 */, int col /* r1+0x14 */) {
    // Local variables
    int i; // r28
    int bomb; // r7
    int sound; // r8
    int kind; // r9
    struct icon_t * icon; // r10
    struct block_t * block; // r27
}

// Range: 0x43148 -> 0x431E8
void CheckChainCounter(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r1+0x4 */) {
    // Local variables
    int row; // r7
    int col; // r1+0x0
...
// Range: 0x431E8 -> 0x43348
int ComboCount(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r1+0xC */) {
    // Local variables
    int i; // r5
    int j; // r31
    int flash; // r1+0x8
