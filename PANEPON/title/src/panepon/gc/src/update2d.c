/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\update2d.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x000ADBDC -> 0x000AE6D4
*/
...
// Range: 0xADBDC -> 0xADF98
void Update2DDistance(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r4 */) {
    // Local variables
    int row; // r1+0x8
    int count; // r9
    int temp; // r1+0x8
...
// Range: 0xAE050 -> 0xAE6D4
void Update2DIcon(struct tetWell * well /* r27 */, struct cursor_t * cursor /* r20 */, int num /* r1+0x14 */) {
    // Local variables
    int i; // r5
    int left; // r28
    int bottom; // r25
