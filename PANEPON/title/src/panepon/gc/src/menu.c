...
static enum /* @enum$105menu_c */ {
    ...
    MT_SCORE_ATTACK = 65,
    MT_STAGE_CLEAR = 66,
} gaeTypeMenu[32]; // size: 0x80, address: 0xE82B0
...
static enum /* @enum$104menu_c */ {
    ML_NONE = 0,
    ML_JAPANESE = 1,
    ML_ENGLISH = 2,
} geLanguageMenu; // size: 0x4, address: 0xE8358
...
static enum /* @enum$107menu_c */ {
    MST_NONE = 0,
    MST_STEREO = 1,
    MST_MONO = 2,
} geMenuSoundType; // size: 0x4, address: 0xE83A4
enum /* @enum$108menu_c */ {
    MSM_BGM = 0,
    MSM_SFX = 1,
    MSM_OFF = 2,
...
static enum /* @enum$108menu_c */ {
    MSM_BGM = 0,
    MSM_SFX = 1,
    MSM_OFF = 2,
    MSM_ALL = 3,
} geMenuSoundMute; // size: 0x4, address: 0xE83A8
...
static enum /* @enum$105menu_c */ {
    ...
    MT_SCORE_ATTACK = 65,
    MT_STAGE_CLEAR = 66,
} geGameType; // size: 0x4, address: 0xE83B0
...
static int menuInitUserData(struct {
    ...
    enum /* @enum$107menu_c */ {
        ...
        MST_STEREO = 1,
        MST_MONO = 2,
    } eSoundType; // offset 0x24, size 0x4
    enum /* @enum$108menu_c */ {
        MSM_BGM = 0,
        MSM_SFX = 1,
        MSM_OFF = 2,
        MSM_ALL = 3,
    } eSoundMute; // offset 0x28, size 0x4
...
enum /* @enum$105menu_c */ {
    ...
    MT_SCORE_ATTACK = 65,
    MT_STAGE_CLEAR = 66,
} geTypeMenu; // size: 0x4, address: 0xF03C4
...
static int menuTestPuzzleStage(enum /* @enum$328menu_c */ {
    MPT_NONE = -1,
    MPS_EASY1 = 0,
    MPS_HARD1 = 1,
    MPS_3D = 2,
...
static int menuTestVsCPUContinue(enum /* @enum$354menu_c */ {
    MVS_NONE = -1,
    MVS_EASY = 0,
    MVS_NORMAL = 1,
    MVS_HARD = 2,
...
static int menuNest(enum /* @enum$105menu_c */ {
    MT_NONE = 0,
    MT_MANY = 1,
    MT_PLAY = 2,
    MT_MAIN = 3,
...
static int menuSetScreen(enum /* @enum$105menu_c */ {
    MT_NONE = 0,
    MT_MANY = 1,
    MT_PLAY = 2,
    MT_MAIN = 3,
    ...
    struct {
        ...
        void (* pfInit)(int, enum /* @enum$105menu_c */ {
            MT_NONE = 0,
            MT_MANY = 1,
            MT_PLAY = 2,
            MT_MAIN = 3,
        ...
        enum /* @enum$105menu_c */ {
            ...
            MT_SCORE_ATTACK = 65,
            MT_STAGE_CLEAR = 66,
        } eTypeNext; // offset 0x14, size 0x4
    } * pMenuData; // r1+0x14
...
static void menuInitRound(int iScreen /* r23 */, enum /* @enum$105menu_c */ {
    MT_NONE = 0,
    MT_MANY = 1,
    MT_PLAY = 2,
    MT_MAIN = 3,
...
static void menuLoad1PStandard(int iName /* r1+0x8 */, enum /* @enum$106menu_c */ {
    MGT_NONE = -1,
    MGT_1P_ENDLESS = 0,
    MGT_1P_VSCPU = 1,
    MGT_1P_SCORE = 2,
...
static void menuSave1PStandard(int iName /* r29 */, enum /* @enum$106menu_c */ {
    MGT_NONE = -1,
    MGT_1P_ENDLESS = 0,
    MGT_1P_VSCPU = 1,
    MGT_1P_SCORE = 2,
...
static void menuLoad2P(int iName /* r1+0x8 */, enum /* @enum$106menu_c */ {
    MGT_NONE = -1,
    MGT_1P_ENDLESS = 0,
    MGT_1P_VSCPU = 1,
    MGT_1P_SCORE = 2,
...
static void menuSave2P(int iName /* r29 */, enum /* @enum$106menu_c */ {
    MGT_NONE = -1,
    MGT_1P_ENDLESS = 0,
    MGT_1P_VSCPU = 1,
    MGT_1P_SCORE = 2,
...
static void pon_menuLoad4P(int iName /* r1+0x8 */, enum /* @enum$106menu_c */ {
    MGT_NONE = -1,
    MGT_1P_ENDLESS = 0,
    MGT_1P_VSCPU = 1,
    MGT_1P_SCORE = 2,
...
static void pon_menuSave4P(int iName /* r29 */, enum /* @enum$106menu_c */ {
    MGT_NONE = -1,
    MGT_1P_ENDLESS = 0,
    MGT_1P_VSCPU = 1,
    MGT_1P_SCORE = 2,
...
static enum /* @enum$354menu_c */ {
    ...
    MVS_SHARD = 3,
    MVS_VHARD = 4,
} eStageLast$1434; // size: 0x4, address: 0xF0408
...
static int menuFindRank(int * pnRank /* r1+0x8 */, int iName /* r1+0xC */, enum /* @enum$2697menu_c */ {
    MRT_NONE = -1,
    MRT_ENDLESS2D = 0,
    MRT_ENDLESS3D = 1,
    MRT_ATTACK2D = 2,
...
enum /* @enum$2991menu_c */ {
    MSD_NORMAL = 0,
    MSD_OFF = 1,
    MSD_TRANSPARENT = 2,
    MSD_BLINKING = 3,
};
static enum /* @enum$2991menu_c */ {
    MSD_NORMAL = 0,
    MSD_OFF = 1,
    MSD_TRANSPARENT = 2,
    MSD_BLINKING = 3,
} geMenuSignDisplay; // size: 0x4, address: 0xF0410
...
} * * ppData /* r1+0x0 */, enum /* @enum$105menu_c */ {
    MT_NONE = 0,
    MT_MANY = 1,
    MT_PLAY = 2,
    MT_MAIN = 3,
...
static void menuRestore(enum /* @enum$105menu_c */ {
    MT_NONE = 0,
    MT_MANY = 1,
    MT_PLAY = 2,
    MT_MAIN = 3,
...
void menuInitFairy(enum /* @enum$95menu_c */ {
    MFP_NONE = 0,
    MFP_LEFT = 1,
    MFP_LEFT_MIDDLE = 2,
    MFP_RIGHT_MIDDLE = 3,
...
void menuTickFairy(int iScreen /* r25 */, int nFrame /* r28 */, int nTagText /* r1+0x10 */, int nOffsetText /* r26 */, int nOffsetBox /* r29 */, enum /* @enum$95menu_c */ {
    MFP_NONE = 0,
    MFP_LEFT = 1,
    MFP_LEFT_MIDDLE = 2,
    MFP_RIGHT_MIDDLE = 3,
    MFP_RIGHT = 4,
} ePosition /* r1+0x1C */, int bArrow /* r27 */) {
    // Local variables
    struct {
        // total size: 0xA0
        int iFrame; // offset 0x0, size 0x4
