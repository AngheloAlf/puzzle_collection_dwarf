/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\init3d.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x000651F4 -> 0x00065D60
*/
...
// Range: 0x651F4 -> 0x653F4
void Init3DNewRow(struct tetWell * well /* r28 */) {
    // Local variables
    int j; // r26
    int old; // r26
    int target; // r31
...
// Range: 0x653F4 -> 0x65468
void Init3DCursor(struct cursor_t * cursor /* r1+0x0 */, int num /* r1+0x4 */) {
    // References
    // -> struct Game gTheGame;
}

// Range: 0x65468 -> 0x6551C
void Init3DTetrisBlocks(struct tetWell * well /* r24 */) {
    // Local variables
    int i; // r26
    int j; // r25
...
// Range: 0x6551C -> 0x65590
void Init3DTetrisBlocksState(struct tetWell * well /* r3 */) {
    // Local variables
    int row; // r28
    int col; // r27
    struct block_t * block; // r3
...
// Range: 0x65590 -> 0x6560C
void Init3DIcons(struct tetWell * well /* r3 */) {
    // Local variables
    int i; // r28
    struct icon_t * icon; // r4
}

// Range: 0x6560C -> 0x65708
void Init3DAttackBlocks(struct tetWell * well /* r3 */) {
    // Local variables
    int i; // r1+0x0
    struct attack_t * attack; // r12
}

// Range: 0x65708 -> 0x657F8
void Init3DExplosion(struct tetWell * well /* r3 */) {
    // Local variables
    int i; // r31
    struct explode_t * explode; // r30
}

// Range: 0x657F8 -> 0x65984
void Init3DText() {
    // Local variables
    int i; // r8
...
// Range: 0x659E4 -> 0x65A04
void Init3DSmallStars(int num /* r3 */) {}

// Range: 0x65A04 -> 0x65A24
void Init3DCircleStars(int num /* r3 */, int pos /* r4 */) {}

// Range: 0x65A24 -> 0x65C10
void Init3DGameOverSmoke(struct tetWell * well /* r3 */, int num /* r1+0xC */) {
    // Local variables
    int i; // r8
    int j; // r9
    struct explode_t * explode; // r12
    int left[8]; // r1+0x50
    int right[8]; // r1+0x30
...
union {
    long m[4][4]; // offset 0x0, size 0x40
    long long force_structure_alignment; // offset 0x0, size 0x8
} gIdent; // size: 0x40, address: 0x50F08
...
// Range: 0x65C50 -> 0x65CDC
int Return3DComboTile(int combo /* r1+0x0 */) {
    // Local variables
    int which; // r4
}

// Range: 0x65CDC -> 0x65D60
int Return3DChainTile(int chain /* r1+0x0 */) {
    // Local variables
    int which; // r1+0x0
}
