/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_water1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00031000 -> 0x0003206C
*/
...
// Range: 0x31448 -> 0x31BA8
void UpdateWater1(int combo /* r27 */, int chain /* r28 */) {
    // Local variables
    int anim; // r31
...
// Range: 0x31BA8 -> 0x3206C
void DrawWater1Lake2D(struct_pon_gc_draw_c_2466 * dynamicp /* r31 */) {
    // Local variables
