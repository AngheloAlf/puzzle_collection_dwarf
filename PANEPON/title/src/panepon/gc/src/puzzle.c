/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\puzzle.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0007FE50 -> 0x00080C24
*/
unsigned char puzzle00[711]; // size: 0x2C7, address: 0xB3FA0
unsigned char puzzle01[1118]; // size: 0x45E, address: 0xB4268
unsigned char puzzle02[977]; // size: 0x3D1, address: 0xB46C8
unsigned char puzzle03[1355]; // size: 0x54B, address: 0xB4A9C
unsigned char puzzle04[1362]; // size: 0x552, address: 0xB4FE8
unsigned char puzzle3D[5356]; // size: 0x14EC, address: 0xB553C
// Range: 0x7FE50 -> 0x7FEBC
void Match2DPuzzle(unsigned char * * ptr /* r1+0x0 */, int level /* r1+0x4 */) {
    // References
...
// Range: 0x7FEBC -> 0x800D0
int Init2DPuzzle(struct tetWell * well /* r27 */, struct cursor_t * cursor /* r28 */, unsigned char * ptr /* r29 */, int number /* r30 */) {
    // Local variables
    int count; // r4
    int total; // r3
    int type; // r4
...
// Range: 0x800D0 -> 0x802B0
int Save2DPuzzle(struct tetWell * well /* r3 */, struct cursor_t * cursor /* r1+0x4 */, unsigned char * ptr /* r12 */) {
    // Local variables
    int row; // r1+0x0
    int col; // r1+0x0
    int total; // r10
    int flag; // r11
    unsigned char temp; // r1+0x0
    unsigned char value; // r9
}

// Range: 0x802B0 -> 0x805A8
int Init3DPuzzle(struct tetWell * well /* r28 */, struct cursor_t * cursor /* r29 */, unsigned char * ptr /* r30 */, int number /* r31 */) {
    // Local variables
    int count; // r3
    int total; // r1+0x8
    int type; // r6
...
// Range: 0x805A8 -> 0x806A0
void EncodeWell(struct tetWell * well /* r3 */, struct tetWell * empty /* r1+0x4 */, int pos /* r1+0x8 */) {
    // Local variables
    int row; // r1+0x0
    int type; // r4
    int code; // r10
...
// Range: 0x806A0 -> 0x80764
void DecodeWell(struct tetWell * well /* r3 */, struct tetWell * empty /* r1+0x4 */, int pos /* r1+0x8 */) {
    // Local variables
    int row; // r1+0x0
    int type; // r1+0x0
    int code; // r5
...
// Range: 0x80764 -> 0x80798
int CheckPlayerPuzzle(int number /* r1+0x0 */) {
    // References
...
// Range: 0x80798 -> 0x80838
int LoadPuzzleEditor(int number /* r1+0x8 */) {
    // Local variables
    struct tetWell * well; // r31
    struct cursor_t * cursor; // r30
...
// Range: 0x80838 -> 0x808A8
int SavePuzzleEditor(int number /* r1+0x8 */) {
    // Local variables
    struct tetWell * well; // r6
...
// Range: 0x808A8 -> 0x80928
int DeletePuzzleEditor(int number /* r29 */) {
    // Local variables
    struct tetWell * well; // r31
    struct cursor_t * cursor; // r30
    unsigned char * ptr; // r5
...
// Range: 0x80928 -> 0x8097C
void InitPuzzleEditor(int first /* r1+0x8 */) {
    // Local variables
...
// Range: 0x809C8 -> 0x80C24
void DrawPuzzleEditor(struct {
    // total size: 0x31B88
    union {
        struct {
            // total size: 0x8
