...
void Init2DTetrisTMEM(struct block_t * block /* r1+0x0 */, union_pon_gc_c_1 * rect /* r1+0x4 */) {}
...
void Init2DAttackTMEM(union_pon_gc_c_1 * rect /* r31 */, int type /* r4 */, int lev /* r5 */, int pos /* r6 */) {
    // Local variables
    int value; // r1+0x8
}
