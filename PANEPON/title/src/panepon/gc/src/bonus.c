...
*/
union_pon_gc_c_222 gCountDown[8]; // size: 0xC0, address: 0xAFA38
...
void InitBonus() {
    ...
    union_pon_gc_tex_c_7332 * txtr; // r7
...
void DrawBonus(struct_pon_gc_draw_c_2466 * dynamicp /* r30 */) {
    // Local variables
    int count; // r26
...
union_pon_gc_tex_c_7332 countLUT[]; // size: 0x0, address: 0xDC028
union_pon_gc_tex_c_7332 countTexture[]; // size: 0x0, address: 0xDC840
...
void DrawStageClearIntro(struct_pon_gc_draw_c_2466 * dynamicp /* r30 */) {
    // Local variables
    int r; // r29
    int g; // r28
    int b; // r31
