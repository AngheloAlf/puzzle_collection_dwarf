...
} gCountDown[8]; // size: 0xC0, address: 0xAFA38
...
union {
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} countLUT[]; // size: 0x0, address: 0xDC028
union {
    struct {
        // total size: 0x18
        unsigned long type; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} countTexture[]; // size: 0x0, address: 0xDC840
...
void DrawStageClearIntro(struct {
    // total size: 0x31B88
    union {
        struct {
            // total size: 0x8
