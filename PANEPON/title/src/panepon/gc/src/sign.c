...
void LoadGameOver2D() {
    ...
    union_pon_gc_tex_c_12 * bg; // r1+0x8
    union_pon_gc_tex_c_7 * txtr; // r4
    int posX[4]; // r1+0x78
...
void LoadGameOver3D() {
    ...
    struct cursor_t * cursor2; // r8
    union_pon_gc_tex_c_12 * bg; // r12
    union_pon_gc_tex_c_7 * txtr; // r11
...
void DrawPauseOver(struct_pon_gc_draw_c_15 * dynamicp /* r3 */) {
    // References
    // -> int gMain;
}
...
void AnimateWin2D(struct tetWell * well /* r1+0x8 */, union_pon_gc_tex_c_12 * bg /* r1+0xC */, union {
...
void AnimateWin3D(struct tetWell * well /* r1+0x0 */, union_pon_gc_tex_c_12 * bg /* r1+0x4 */, union {
    struct_pon_gc_tex_c_5 b; // offset 0x0, size 0x28
    struct_pon_gc_tex_c_6 s; // offset 0x0, size 0x28
    long long force_structure_alignment; // offset 0x0, size 0x8
} * alpha /* r1+0x8 */) {
...
void AnimateLose2D(struct tetWell * well /* r1+0x8 */, union_pon_gc_tex_c_12 * bg /* r1+0xC */, union {
    struct_pon_gc_tex_c_5 b; // offset 0x0, size 0x28
    struct_pon_gc_tex_c_6 s; // offset 0x0, size 0x28
    long long force_structure_alignment; // offset 0x0, size 0x8
} * alpha /* r1+0x10 */) {
...
void AnimateLose3D(struct tetWell * well /* r1+0x0 */, union_pon_gc_tex_c_12 * bg /* r1+0x4 */, union {
    struct_pon_gc_tex_c_5 b; // offset 0x0, size 0x28
    struct_pon_gc_tex_c_6 s; // offset 0x0, size 0x28
    long long force_structure_alignment; // offset 0x0, size 0x8
} * alpha /* r1+0x8 */) {
...
void AnimateDraw2D(struct tetWell * well /* r1+0x8 */, union_pon_gc_tex_c_12 * bg /* r1+0xC */, union {
    struct_pon_gc_tex_c_5 b; // offset 0x0, size 0x28
    struct_pon_gc_tex_c_6 s; // offset 0x0, size 0x28
    long long force_structure_alignment; // offset 0x0, size 0x8
} * alpha /* r1+0x10 */) {
...
void AnimateDraw3D(struct tetWell * well /* r1+0x0 */, union_pon_gc_tex_c_12 * bg /* r1+0x4 */, union {
    struct_pon_gc_tex_c_5 b; // offset 0x0, size 0x28
    struct_pon_gc_tex_c_6 s; // offset 0x0, size 0x28
    long long force_structure_alignment; // offset 0x0, size 0x8
} * alpha /* r1+0x8 */) {
...
void AnimatePauseKey(union_pon_gc_tex_c_12 * bg /* r1+0x0 */) {
    // References
...
void AnimatePushKey(union_pon_gc_tex_c_12 * bg /* r1+0x0 */) {
    // References
    // -> int gWhatever;
    // -> signed char pushkeyShake[30];
}
...
void pon_Animate2DRanking4p(struct tetWell * well /* r1+0x8 */, union_pon_gc_tex_c_12 * bg /* r1+0xC */, union {
    struct_pon_gc_tex_c_5 b; // offset 0x0, size 0x28
    struct_pon_gc_tex_c_6 s; // offset 0x0, size 0x28
    long long force_structure_alignment; // offset 0x0, size 0x8
