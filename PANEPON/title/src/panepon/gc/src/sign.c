...
void AnimateWin2D(struct tetWell * well /* r1+0x8 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
...
void AnimateWin3D(struct tetWell * well /* r1+0x0 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
...
void AnimateLose2D(struct tetWell * well /* r1+0x8 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
...
void AnimateLose3D(struct tetWell * well /* r1+0x0 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
...
void AnimateDraw2D(struct tetWell * well /* r1+0x8 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
...
void AnimateDraw3D(struct tetWell * well /* r1+0x0 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
...
void pon_Animate2DRanking4p(struct tetWell * well /* r1+0x8 */, union {
    struct {
        // total size: 0x28
        unsigned short imageX; // offset 0x0, size 0x2
        unsigned short imageW; // offset 0x2, size 0x2
