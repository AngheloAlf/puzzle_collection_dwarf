/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\tutorial.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x000A8468 -> 0x000A92A8
*/
unsigned char tutorial1[108]; // size: 0x6C, address: 0xDFC18
unsigned char tutorial2[253]; // size: 0xFD, address: 0xDFC84
unsigned char tutorial3[522]; // size: 0x20A, address: 0xDFD84
unsigned char tutorial4[132]; // size: 0x84, address: 0xDFF90
unsigned char tutorial5[24]; // size: 0x18, address: 0xE0014
unsigned char tutorial6[38]; // size: 0x26, address: 0xE002C
unsigned char garbage_rebreak[48]; // size: 0x30, address: 0xE0054
unsigned char tutorial_move1[502]; // size: 0x1F6, address: 0xE0084
unsigned char tutorial_move2[673]; // size: 0x2A1, address: 0xE027C
unsigned char tutorial_move3[562]; // size: 0x232, address: 0xE0520
unsigned char tutorial_move4[226]; // size: 0xE2, address: 0xE0754
unsigned char tutorial_move5[466]; // size: 0x1D2, address: 0xE0838
unsigned char tutorial_move6[223]; // size: 0xDF, address: 0xE0A0C
struct command_t {
    // total size: 0xC
...
// Range: 0xA8468 -> 0xA85C8
int TutorialPattern() {
    // Local variables
    int count; // r6
    unsigned char * ptr; // r3
    int type; // r3

    // References
    // -> struct ai_t brainbrain[4];
    // -> unsigned char garbage_rebreak[48];
}
...
// Range: 0xA85C8 -> 0xA8E20
void InitTutorial() {
    // Local variables
    int num; // r24
    int iScreen; // r25
    struct tetWell * well; // r26
    struct cursor_t * cursor; // r22
    struct ai_t * brain; // r24
    union {
        struct {
            // total size: 0x18
            signed short objX; // offset 0x0, size 0x2
    ...
    // References
    // -> unsigned char tutorial_move5[466];
    // -> unsigned short gGameStatus;
    // -> int gMax;
    // -> struct Game gTheGame;
    // -> unsigned char tutorial6[38];
    // -> unsigned char tutorial5[24];
    // -> unsigned char tutorial4[132];
    // -> unsigned char tutorial3[522];
    // -> unsigned char tutorial2[253];
    // -> unsigned char tutorial1[108];
    // -> struct ai_t brainbrain[4];
...
// Range: 0xA8E20 -> 0xA9198
void TutorialCheckState(struct tetWell * well /* r29 */, struct cursor_t * cursor /* r30 */) {
    // Local variables
    int count; // r3
    int col; // r5
    int result; // r7
...
} * tut_dynamicp; // size: 0x4, address: 0x116FE8
// Range: 0xA9234 -> 0xA92A8
void DrawTUT(union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
