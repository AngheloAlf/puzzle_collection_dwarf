/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\pon_gc_anim_mini_vs.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0000D17C -> 0x00011C54
*/
long Init_position_normal_posY_2p[17]; // size: 0x44, address: 0xEE0
long Init_position_win_posY_2p[17]; // size: 0x44, address: 0xF24
unsigned short Init_imageFlip_2p[17][2]; // size: 0x44, address: 0xF68
signed short Init_mini_frameX_2p[17][2]; // size: 0x44, address: 0xFAC
signed short Init_specialattack_frameX_2p[17][2]; // size: 0x44, address: 0xFF0
long Init_position_normal_posY_4p[17]; // size: 0x44, address: 0x1034
long Init_position_win_posY_4p[17]; // size: 0x44, address: 0x1078
signed short Init_mini_frameX_4p[17][4]; // size: 0x88, address: 0x10BC
signed short Init_specialattack_frameX_4p[17][4]; // size: 0x88, address: 0x1144
int InittrackData[17][5]; // size: 0x154, address: 0x11CC
int Initcurrent_flicData[17][7]; // size: 0x1DC, address: 0x1320
int InitalphaRGBData[17][3]; // size: 0xCC, address: 0x14FC
struct block_t {
    // total size: 0x2C
...
union_pon_gc_c_222 mini_shadow[4]; // size: 0x60, address: 0x1768
int anim_bg; // size: 0x4, address: 0x1760
int anim_sp; // size: 0x4, address: 0x1764
// Range: 0xD17C -> 0x10FE0
void pon_InitLevel(int who /* r23 */, int player /* r20 */, int count /* r21 */, int animeflag /* r24 */) {
    // Local variables
    int base; // r1+0x8
    int temp; // r17
    long Init_position_normal_posY; // r29
    long Init_position_win_posY; // r28
    unsigned short Init_imageFlip; // r27
    signed short Init_mini_frameX; // r26
    signed short Init_specialattack_frameX; // r25
    ...
    // -> int gWorld;
    // -> int Initcurrent_flicData[17][7];
    // -> int InitalphaRGBData[17][3];
    // -> unsigned char alphaB[4];
    // -> unsigned char alphaG[4];
    // -> unsigned char alphaR[4];
    // -> int InittrackData[17][5];
    // -> char * * gaSegmentCharacter[];
    // -> signed short Init_specialattack_frameX_4p[17][4];
    // -> signed short Init_mini_frameX_4p[17][4];
    // -> long Init_position_win_posY_4p[17];
    // -> long Init_position_normal_posY_4p[17];
    // -> signed short Init_specialattack_frameX_2p[17][2];
    // -> signed short Init_mini_frameX_2p[17][2];
    // -> unsigned short Init_imageFlip_2p[17][2];
    // -> long Init_position_win_posY_2p[17];
...
void pon_SetSpecialAttack(int attacker /* r1+0x8 */, int victim /* r1+0xC */, int count /* r1+0x10 */) {
    ...
    int base; // r12
    int temp; // r1+0x8
    signed short Init_specialattack_frameX; // r1+0x8
