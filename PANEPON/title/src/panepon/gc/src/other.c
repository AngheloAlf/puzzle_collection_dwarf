...
union_pon_gc_tex_c_7332 otherTexture9[]; // size: 0x0, address: 0xD05C8
union_pon_gc_tex_c_7332 otherTexture10[]; // size: 0x0, address: 0xD05E0
union_pon_gc_tex_c_7332 otherTexture11[]; // size: 0x0, address: 0xD05F8
// Range: 0x7D520 -> 0x7D7EC
void Draw2DMiscStuff(struct_pon_gc_draw_c_2466 * dynamicp /* r31 */) {
    // Local variables
    int num; // r22
...
void Draw3DMiscStuff(struct_pon_gc_draw_c_2466 * dynamicp /* r30 */) {
    // Local variables
    int num; // r1+0x8
