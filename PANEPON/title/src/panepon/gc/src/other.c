/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\other.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0007CCE4 -> 0x0007E61C
*/
struct block_t {
    // total size: 0x2C
...
// Range: 0x7D004 -> 0x7D304
void pon_InitMiscStuff4p() {
    // Local variables
    int offset; // r11
    int count; // r1+0x8
    int color; // r22
...
// Range: 0x7D304 -> 0x7D520
void UpdateMiscStuff(struct tetWell * well /* r1+0x0 */, struct cursor_t * cursor /* r1+0x4 */, int num /* r1+0x8 */) {
    // Local variables
    int shake; // r4
...
union_pon_gc_tex_c_7 otherTexture9[]; // size: 0x0, address: 0xD05C8
union_pon_gc_tex_c_7 otherTexture10[]; // size: 0x0, address: 0xD05E0
union_pon_gc_tex_c_7 otherTexture11[]; // size: 0x0, address: 0xD05F8
// Range: 0x7D520 -> 0x7D7EC
void Draw2DMiscStuff(struct_pon_gc_draw_c_15 * dynamicp /* r31 */) {
    // Local variables
    int num; // r22
    struct cursor_t * cursor; // r3
    ...
    // -> union [anonymous] otherTexture11[];
    // -> union [anonymous] otherTexture10[];
    // -> union [anonymous] otherTexture9[];
...
unsigned char w_level1[]; // size: 0x0, address: 0xC9F88
unsigned char w_level2[]; // size: 0x0, address: 0xCA788
unsigned char w_template5[]; // size: 0x0, address: 0xCD788
unsigned char w_template6[]; // size: 0x0, address: 0xCDC08
unsigned char w_template7[]; // size: 0x0, address: 0xCE088
unsigned short numberTable[]; // size: 0x0, address: 0xD0670
// Range: 0x7D7EC -> 0x7E61C
void Draw3DMiscStuff(struct_pon_gc_draw_c_15 * dynamicp /* r30 */) {
    // Local variables
    int num; // r1+0x8
    struct cursor_t * cursor; // r6
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
    union_pon_gc_c_0 * _g; // r1+0x8
    ...
    // -> unsigned char w_template7[];
    // -> unsigned char w_template6[];
    // -> unsigned char w_template5[];
    // -> unsigned short otherTable[];
    // -> int gMain;
    // -> int gSelection;
    // -> struct Game gTheGame;
    // -> unsigned char w_template1[];
    // -> unsigned char w_level2[];
    // -> unsigned char w_level1[];
}
