/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_devil1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0002ADC8 -> 0x0002C28C
*/
...
// Range: 0x2B374 -> 0x2C0F8
void UpdateDevil1(int combo /* r28 */, int chain /* r29 */) {
    // Local variables
    int anim; // r30
    int count; // r1+0x8
    int x; // r5
...
// Range: 0x2C0F8 -> 0x2C26C
void DrawDevil1LifeBar2D() {
    // Local variables
    int length; // r6
    unsigned long color; // r12
...
// Range: 0x2C26C -> 0x2C28C
void DrawDevil1LifeBar3D() {}
