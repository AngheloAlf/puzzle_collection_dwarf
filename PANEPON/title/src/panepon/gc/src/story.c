...
static union_pon_gc_c_173 * gpGfxHeapLast; // size: 0x4, address: 0xF47DC
...
static int storyMakeDustBall(void * ppHeap /* r21 */, @enum$107story_c eType /* r26 */, int nX /* r1+0x10 */, int nY /* r1+0x14 */, int nDustCount /* r14 */) {
    ...
    int nDeltaY; // r5
    int iTry; // r5
    struct_story_c_468 * pDustBall; // r1+0x8
    int nCount; // r1+0x8
    int nSeed; // r4
    int nRate; // r24
    int nWait; // r22
...
static void storyTickDustBall() {
    ...
    int nDeltaX; // r29
    int nDeltaY; // r28
    struct_story_c_468 * pDustBall; // r6
    int iBall; // r7
    int iDust; // r8
    int iTile; // r12
    int nTick; // r28
...
static void storyDrawDustBall(union_pon_gc_c_173 * * ppGfx /* r1+0x8 */, int iBall /* r1+0xC */) {
    // Local variables
...
static void storyMakeRainbow(union_pon_gc_tex_c_1219 * aVtx /* r20 */, int nOffset /* r21 */, float rBase0 /* f28 */, float rBase1 /* r1+0x14 */, float r0 /* f29 */, float r1 /* r1+0x1C */) {
    // Local variables
    int iTile; // r26
    struct_bitmap_c_14 * pBitmap; // r25
    int nBase0; // r19
    int nBase1; // r24
    int nSize0; // r18
    int nSize1; // r23
...
static void storyDrawRainbow(union_pon_gc_c_173 * * ppGfx /* r1+0x8 */, int iRainbow /* r1+0xC */, int nAlpha /* r1+0x10 */) {
    // Local variables
    union_pon_gc_c_173 * pGfx; // r9
    union_pon_gc_tex_c_1219 * pVtx; // r1+0x8
    struct_bitmap_c_14 * pBitmap; // r5
    int iTile; // r11
    int iPage; // r10
    union_pon_gc_c_173 * _g; // r9
...
static void storyDrawIsle(union_pon_gc_c_173 * * ppGfx /* r29 */, int nAlphaGirl /* r30 */) {
    // Local variables
    int bFlag; // r3
...
static void storyDrawGoddess(union_pon_gc_c_173 * * ppGfx /* r1+0x8 */) {
    // Local variables
...
static void storyDrawImage(union_pon_gc_c_173 * * ppGfx /* r30 */, int iScreen /* r29 */, int nTag /* r24 */) {
    // Local variables
...
void DrawStory() {
    ...
    union_pon_gc_c_173 * pGfxHeap; // r1+0xC
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
