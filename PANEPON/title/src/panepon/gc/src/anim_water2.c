/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_water2.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0003273C -> 0x00032888
*/
struct block_t {
    // total size: 0x2C
...
// Erased
static void InitWater2(int flag /* r30 */, int anim /* r31 */) {
    // Local variables
    int base; // r6
    int temp; // r6
    char * currSegment; // r3
    ...
    // -> static char * gc_levwater2;
}

int gCounter; // size: 0x4, address: 0xF4E80
// Range: 0x3273C -> 0x32888
void UpdateWater2() {
    // Local variables
    int x; // r27
    int y; // r29
