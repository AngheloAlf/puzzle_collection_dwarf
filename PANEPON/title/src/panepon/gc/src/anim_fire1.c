/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_fire1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0002C28C -> 0x0002CD40
*/
...
// Range: 0x2C4CC -> 0x2C91C
void UpdateFire1(int combo /* r27 */, int chain /* r28 */) {
    // Local variables
    int anim; // r31
...
// Range: 0x2C91C -> 0x2CB94
void DrawFire1HeatWave2D() {
    // Local variables
    int frame; // r19
    int col; // r4
    int count; // r22
    unsigned short * picture; // r21
    int shift[9]; // r1+0x8
...
// Range: 0x2CB94 -> 0x2CD40
void DrawFire1Smoke2D(struct_pon_gc_draw_c_2466 * dynamicp /* r1+0x8 */) {
    // Local variables
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
    union_pon_gc_c_173 * _g; // r1+0x8
