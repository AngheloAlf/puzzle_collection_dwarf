...
union_pon_gc_tex_c_7 transTexture[]; // size: 0x0, address: 0xD4530
...
void Draw2DMT(struct_pon_gc_draw_c_15 * dynamicp /* r31 */) {
    // Local variables
    int num; // r29
...
void Draw3DMT(struct_pon_gc_draw_c_15 * dynamicp /* r31 */) {
    // Local variables
...
void DrawMT(struct_pon_gc_draw_c_15 * dynamicp /* r31 */) {
    // References
    // -> struct Game gTheGame;
    // -> static @enum$635mimic_c geModeMimic;
    // -> int gMain;
