/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_flower1.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x0002CD40 -> 0x0002E9B0
*/
...
// Range: 0x2D2EC -> 0x2E9B0
void UpdateFlower1(int combo /* r25 */, int chain /* r26 */) {
    // Local variables
    int anim; // r27
    int count; // r1+0x8
    int total; // r7
    ...
    struct_pon_gc_tex_c_9927 * s; // r17
