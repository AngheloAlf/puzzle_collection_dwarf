/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\anim_flower2.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00032148 -> 0x000322F4
*/
struct block_t {
    // total size: 0x2C
...
// Erased
static void InitFlower2(int flag /* r30 */, int anim /* r31 */) {
    // Local variables
    int base; // r6
    int temp; // r7
    char * currSegment; // r3
    ...
    // -> static int gWorld;
    // -> static char * gc_levflower2;
}

int gCounter; // size: 0x4, address: 0xF4E80
// Range: 0x32148 -> 0x322F4
void UpdateFlower2() {
    // Local variables
    int count; // r7
    unsigned short * image; // r1+0x0
