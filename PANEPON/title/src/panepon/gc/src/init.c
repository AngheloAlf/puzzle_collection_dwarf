/*
    Compile unit: C:\users\tsuji\title\src\panepon\gc\src\init.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x00062F68 -> 0x00062F68
*/
static struct {
    // total size: 0x10
    signed short vscale[4]; // offset 0x0, size 0x8
    signed short vtrans[4]; // offset 0x8, size 0x8
} vp; // size: 0x10, address: 0xB0D08
union {
    struct {
        // total size: 0x8
...
} initRDPstart[29]; // size: 0xE8, address: 0xB0D18
union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} initRDP_dl[13]; // size: 0x68, address: 0xB0E00
union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} init2D_dl[9]; // size: 0x48, address: 0xB0E68
union {
    struct {
        // total size: 0x8
        unsigned int w0; // offset 0x0, size 0x4
    ...
    long long force_structure_alignment; // offset 0x0, size 0x8
} init3D_dl[9]; // size: 0x48, address: 0xB0EB0
