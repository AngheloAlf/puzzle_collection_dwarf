...
void UpdateBuffer(struct_pon_gc_c_3 * info /* r3 */) {
    // References
    // -> struct Game gTheGame;
}

// Range: 0xACCC8 -> 0xACFA4
void Update2DBuffer(struct_pon_gc_c_3 * info /* r15 */) {
    // Local variables
...
void Update3DBuffer(struct_pon_gc_c_3 * info /* r1+0x1C */) {
    // Local variables
    struct_pon_gc_draw_c_15 * dynamicp; // r1+0x8
